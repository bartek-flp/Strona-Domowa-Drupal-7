  ...
  <div class="layout-978">
    ...
    <div class="featured-slider">
      <div class="slides displayblock">
        <div class="featured">
          <div class="slide-image"><span class="img-effect pngfix"></span><img width="976" height="313" src="<?php print base_path() . drupal_get_path('theme', 'creative') . '/images/drop.png'; ?>" class="pngfix"/>
          </div> <!-- .slide-image -->
        </div> <!-- .featured -->
